    ...
    <div className="min-h-screen bg-black text-white font-sans">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-xl">
              Trusted property consultant helping clients buy, sell and rent homes
              with confidence. Discover strategic investments, dream homes and
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Professional real estate solutions tailored for homeowners,
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-zinc-900 border border-yellow-500/20 rounded-3xl p-8 hover:border-yellow-400 transition-all shadow-xl">
            ...
            <p className="text-gray-300 leading-relaxed">
              Find your ideal property with trusted guidance and
              market insights.
            </p>
          </div>
          ...
          <div className="bg-zinc-900 border border-yellow-500/20 rounded-3xl p-8 hover:border-yellow-400 transition-all shadow-xl">
            ...
            <p className="text-gray-300 leading-relaxed">
              Maximize property exposure and achieve better market value
              with strategic selling.
            </p>
          </div>
          ...
          <div className="bg-zinc-900 border border-yellow-500/20 rounded-3xl p-8 hover:border-yellow-400 transition-all shadow-xl">
            ...
            <p className="text-gray-300 leading-relaxed">
              Explore rental opportunities for homes, condos and
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <p className="text-gray-400">
                Premium listings by Yoori OD Legacy
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* PROPERTY 1 */}
            <div className="bg-black border border-yellow-500/20 rounded-3xl overflow-hidden shadow-xl hover:border-yellow-400 transition-all">

              <div className="h-60 bg-gradient-to-br from-yellow-400/20 to-zinc-800 flex items-center justify-center text-7xl">
                🏡
              </div>
              ...
              <div className="p-6">
                ...
                <p className="text-gray-400 mb-5">
                  Jalan Ronggeng 12, Tun Aminah
                </p>

                <div className="grid grid-cols-3 gap-4 text-sm text-gray-300 border-t border-white/10 pt-4 mb-5">
                ...
                <div className="space-y-2 text-gray-300 text-sm leading-relaxed">
                  <p>📍 Near Sutera Mall, Impian Emas, Perling & Nusa Bestari</p>
                  <p>✨ Fully renovated & fully tiled</p>
                  <p>✨ Fully extended (front, back & upper floor)</p>
                  <p>✨ Upstairs family hall</p>
                  <p>✨ Leasehold until 2082</p>
                  <p>✨ Peaceful Chinese neighbourhood</p>
                </div>
            ...
            <div className="bg-black border border-yellow-500/20 rounded-3xl overflow-hidden shadow-xl hover:border-yellow-400 transition-all">
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 text-gray-300 text-sm leading-relaxed">
                  <p>✨ Fully renovated</p>
                  <p>✨ Extended kitchen</p>
                  <p>✨ Stainless steel door</p>
                  <p>✨ Fully tiled flooring</p>
                  <p>✨ Tiled car porch</p>
                  <p>✨ Freehold property</p>
                </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-400 mb-10 max-w-2xl mx-auto text-lg">
          Connect with Yoori OD Legacy Property today for trusted property
          consultation and premium listings.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a
            ...
            className="bg-yellow-400 hover:bg-yellow-300 text-black font-semibold px-8 py-4 rounded-2xl shadow-xl transition-all"
          >
            WhatsApp Now
          </a>
